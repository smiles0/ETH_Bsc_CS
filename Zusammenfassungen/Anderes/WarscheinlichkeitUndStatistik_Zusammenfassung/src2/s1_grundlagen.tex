...
\begin{definition}[Empirische Varianz]
	\( S^2 = \frac{1}{n-1} \sum_{i=1}^n (X_i-\overline{X}_n)^2 \)
\end{definition}

\begin{definition}[k-tes Empirisches Moment]
	\( \hat{m}_k := \frac{1}{n} \sum_{i=1}^n X_i^k \)
\end{definition}

\begin{definition}[Empirisches Quantil] Das \emph{empirische \(\alpha\)-Quantil} \(x_\alpha\)
